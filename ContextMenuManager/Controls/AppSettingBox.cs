...
namespace ContextMenuManager.Controls
{
    sealed class AppSettingBox : MyList
    {
        public AppSettingBox()
        {
            ...
            cmbConfigDir.Width = cmbEngine.Width = 120.DpiZoom();
            cmbConfigDir.DropDownStyle = cmbEngine.DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        {
            this.AddItems(new[] { mliConfigDir, mliEngine, mliBackup, mliTopMost, mliProtect, mliShowFilePath,
